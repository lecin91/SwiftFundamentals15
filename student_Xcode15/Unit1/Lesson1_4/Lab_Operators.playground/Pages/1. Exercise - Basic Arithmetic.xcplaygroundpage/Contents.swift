...
// by using the remainder operator to determine even or odd is determined based on the total that prints after the action. Since the remainder for even = 0 is even, for odd we got a remainder of 1.
