...
//It does differ from the previous average because this type is a 'Double' meaning it's going to print numbers in decmiimal form. While the previous type was a whole number (Int) type.
...
let percentOfGold = (steps / goal) * 100
print(percentOfGold)
